# 11 - Smets & Wouters (2003) database -----
...
ggsave("01_TED_EA19_hours.png", path = fig_path, height = 4, width = 6)
graphics.off()
...
ggsave("02_TED_EA19_hours-approx.png", path = fig_path, height = 4, width = 6)
graphics.off()
...
ggsave("03_TED_EA19_hours-comparison.png", path = fig_path, height = 4, width = 6)
graphics.off()
...
ggsave("04_Eurostat_population.png", path = fig_path, height = 4, width = 6)
graphics.off()
...
ggsave("05_Eurostat_population-approx.png", path = fig_path, height = 4, width = 6)
graphics.off()
...
ggsave("06_Eurostat_population-comparison.png", path = fig_path, height = 4, width = 6)
graphics.off()
...
ggsave("07_Eurostat_population-growthrates.png", path = fig_path, height = 4, width = 6)
graphics.off()
...
ggsave("08_Eurostat_population-smoothed.png", path = fig_path, height = 4, width = 6)
graphics.off()
...
ggsave("09_final-database.png", path = fig_path, height = 4, width = 6)
graphics.off()
