...
ggsave("01_SCR-SCT.png", path = fig_path, height = 12, width = 24)
graphics.off()
...
ggsave("02_SC-chain.png", path = fig_path, height = 12, width = 24)
graphics.off()
...
ggsave("03_unemp-comp.png", path = fig_path, height = 12, width = 24)
graphics.off()
...
ggsave("04_revenue-expenditures.png", path = fig_path, height = 12, width = 24)
graphics.off()
...
grid.arrange(arrangeGrob(p1, p2, ncol = 2))
ggsave("05_consumption-investment.png", path = fig_path, height = 12, width = 24)
graphics.off()
...
grid.arrange(arrangeGrob(p1, p2, ncol = 2))
ggsave("06_compensation-subsidies.png", path = fig_path, height = 12, width = 24)
graphics.off()
...
grid.arrange(arrangeGrob(p1, p2, ncol = 2))
ggsave("07_indirect-direct-taxation.png", path = fig_path, height = 12, width = 24)
graphics.off()
...
grid.arrange(arrangeGrob(p1, p2, ncol = 2))
ggsave("08_interest-debt.png", path = fig_path, height = 12, width = 24)
graphics.off()
...
grid.arrange(arrangeGrob(p1, p2, ncol = 2))
ggsave("09_transfers-benefits.png", path = fig_path, height = 12, width = 24)
graphics.off()
...
ggsave("10_final.png", path = fig_path, height = 12, width = 24)
graphics.off()
