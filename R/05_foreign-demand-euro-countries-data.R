...
ggsave("01_imports_levels.png", path = fig_path, height = 8, width = 12)
graphics.off()
...
ggsave("02_imports_gr.png", path = fig_path, height = 8, width = 12)
graphics.off()
...
ggsave("03_exports_FR_gr.png", path = fig_path, height = 8, width = 12)
graphics.off()
...
ggsave("04_importance_FR.png", path = fig_path, height = 8, width = 12)
graphics.off()
...
ggsave("05_imports_DE_levels.png", path = fig_path, height = 8, width = 12)
graphics.off()
...
ggsave("06_imports_DE_gr.png", path = fig_path, height = 8, width = 12)
graphics.off()
...
ggsave("07_exports_DE_gr.png", path = fig_path, height = 8, width = 12)
graphics.off()
# Before 1999, both series are very similar. 
# Compute weights of 18 commercial partners after 1999 
...
ggsave("08_importance_DE.png", path = fig_path, height = 8, width = 12)
graphics.off()
...
ggsave("09_imports_IT_levels.png", path = fig_path, height = 8, width = 12)
graphics.off()
...
ggsave("10_imports_IT_gr.png", path = fig_path, height = 8, width = 12)
graphics.off()
...
ggsave("11_exports_IT_gr.png", path = fig_path, height = 8, width = 12)
graphics.off()
...
ggsave("12_importance_IT.png", path = fig_path, height = 8, width = 12)
graphics.off()
...
ggsave("13_imports_ES_levels.png", path = fig_path, height = 8, width = 12)
graphics.off()
...
ggsave("14_imports_ES_gr.png", path = fig_path, height = 8, width = 12)
graphics.off()
...
ggsave("15_exports_ES_gr.png", path = fig_path, height = 8, width = 12)
graphics.off()
...
ggsave("16_importance_ES.png", path = fig_path, height = 8, width = 12)
graphics.off()
...
ggsave("17_foreign-demand.png", path = fig_path, height = 8, width = 12)
graphics.off()
