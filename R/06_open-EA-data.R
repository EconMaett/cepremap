...
ggsave("01_imports.png", path = fig_path, height = 8, width = 12)
graphics.off()
...
ggsave("03_exports-east.png", path = fig_path, height = 8, width = 12)
graphics.off()
...
ggsave("04_imports-brics.png", path = fig_path, height = 8, width = 12)
graphics.off()
...
ggsave("05_exports-ea.png", path = fig_path, height = 8, width = 12)
graphics.off()
...
ggsave("06_foreign-demand-ea.png", path = fig_path, height = 8, width = 12)
graphics.off()
...
ggsave("07_foreign-interest-rate.png", path = fig_path, height = 8, width = 12)
graphics.off()
...
ggsave("08_oil-price.png", path = fig_path, height = 8, width = 12)
graphics.off()
...
ggsave("09_reer.png", path = fig_path, height = 8, width = 12)
graphics.off()
...
ggsave("10_ea-imports-exports.png", path = fig_path, height = 8, width = 12)
graphics.off()
...
ggsave("11_final.png", path = fig_path, height = 8, width = 12)
graphics.off()
