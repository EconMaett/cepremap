...
ggsave("01_BIS_credit_nfc.png", path = fig_path, height = 8, width = 12)
graphics.off()
...
ggsave("02_BIS_credit_hh.png", path = fig_path, height = 8, width = 12)
graphics.off()
...
ggsave("03_BIS_credit_nfc_chained.png", path = fig_path, height = 8, width = 12)
graphics.off()
...
ggsave("04_BIS_credit_hh_chained.png", path = fig_path, height = 8, width = 12)
graphics.off()
...
ggsave("05_ECB_lendingrates.png", path = fig_path, height = 8, width = 12)
graphics.off()
...
ggsave("06_ECB_lendingrates_longterm.png", path = fig_path, height = 8, width = 12)
graphics.off()
...
ggsave("07_ECB_entrepreneurialnetworth.png", path = fig_path, height = 8, width = 12)
graphics.off()
...
ggsave("08_ECB_houseprices.png", path = fig_path, height = 8, width = 12)
graphics.off()
...
ggsave("09_final.png", path = fig_path, height = 8, width = 12)
graphics.off()
...
ggsave("10_CMR_EA.png", path = fig_path, height = 8, width = 12)
graphics.off()
