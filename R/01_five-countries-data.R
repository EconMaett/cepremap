...
ggsave("01_gov_cons_DE-ES-IT.png", path = fig_path, height = 12, width = 24)
graphics.off()
...
ggsave("02_gov_inves_DE-ES-IT.png", path = fig_path, height = 12, width = 24)
graphics.off()
...
ggsave("03_gov_transf_DE-ES-IT.png", path = fig_path, height = 12, width = 24)
graphics.off()
...
ggsave("04_gov_intpay_DE-ES-IT.png", path = fig_path, height = 12, width = 24)
graphics.off()
...
ggsave("05_gov_exp_DE-ES-IT.png", path = fig_path, height = 12, width = 24)
graphics.off()
...
ggsave("06_gov_rev_DE-ES-IT.png", path = fig_path, height = 12, width = 24)
graphics.off()
...
ggsave("07_gov_debt_DE-ES-FR-IT.png", path = fig_path, height = 12, width = 24)
graphics.off()
...
ggsave("08_unempbenef_DE-ES-FR-IT.png", path = fig_path, height = 12, width = 24)
graphics.off()
...
ggsave("09_unchained_DE-ES-FR-IT.png", path = fig_path, height = 12, width = 24)
graphics.off()
...
ggsave("10_gov_debt_FR.png", path = fig_path, height = 12, width = 24)
graphics.off()
...
ggsave("11_pop_FR.png", path = fig_path, height = 12, width = 24)
graphics.off()
...
ggsave("12_lendingrate_FR.png", path = fig_path, height = 12, width = 24)
graphics.off()
...
ggsave("13_unempbenef_FR.png", path = fig_path, height = 12, width = 24)
graphics.off()
...
ggsave("14_gov_debt_ES.png", path = fig_path, height = 12, width = 24)
graphics.off()
...
ggsave("15_pop_ES.png", path = fig_path, height = 12, width = 24)
graphics.off()
...
ggsave("16_lendingrate_ES.png", path = fig_path, height = 12, width = 24)
graphics.off()
...
ggsave("17_unempbenef_ES.png", path = fig_path, height = 12, width = 24)
graphics.off()
...
ggsave("18_govdebt_DE.png", path = fig_path, height = 12, width = 24)
graphics.off()
...
ggsave("19_pop_DE.png", path = fig_path, height = 12, width = 24)
graphics.off()
...
ggsave("20_lendingrate_DE.png", path = fig_path, height = 12, width = 24)
graphics.off()
...
ggsave("21_unempbenef_DE.png", path = fig_path, height = 12, width = 24)
graphics.off()
...
ggsave("22_gov_cons_DE.png", path = fig_path, height = 12, width = 24)
graphics.off()
...
ggsave("23_gov_inves_DE.png", path = fig_path, height = 12, width = 24)
graphics.off()
...
ggsave("24_gov_soctransf_DE.png", path = fig_path, height = 12, width = 24)
graphics.off()
...
ggsave("25_gov_exp_DE.png", path = fig_path, height = 12, width = 24)
graphics.off()
...
ggsave("26_gov_rev_DE.png", path = fig_path, height = 12, width = 24)
graphics.off()
...
ggsave("27_gov_intpay_DE.png", path = fig_path, height = 12, width = 24)
graphics.off()
...
ggsave("28_consumption_IT.png", path = fig_path, height = 12, width = 24)
graphics.off()
...
ggsave("29_investment_IT.png", path = fig_path, height = 12, width = 24)
graphics.off()
...
ggsave("30_invesdef_IT.png", path = fig_path, height = 12, width = 24)
graphics.off()
...
ggsave("31_govdebt_IT.png", path = fig_path, height = 12, width = 24)
graphics.off()
...
ggsave("32_pop_IT.png", path = fig_path, height = 12, width = 24)
graphics.off()
...
ggsave("33_lendingrate_IT.png", path = fig_path, height = 12, width = 24)
graphics.off()
...
ggsave("34_unempbenef_IT.png", path = fig_path, height = 12, width = 24)
graphics.off()
...
ggsave("35_govcons_IT.png", path = fig_path, height = 12, width = 24)
graphics.off()
...
ggsave("36_gov_inv_IT.png", path = fig_path, height = 12, width = 24)
graphics.off()
...
ggsave("37_gov_soctransf_IT.png", path = fig_path, height = 12, width = 24)
graphics.off()
...
ggsave("38_gov_exp_IT.png", path = fig_path, height = 12, width = 24)
graphics.off()
...
ggsave("39_gov_rev_IT.png", path = fig_path, height = 12, width = 24)
graphics.off()
...
ggsave("40_gov_intpay_IT.png", path = fig_path, height = 12, width = 24)
graphics.off()
...
ggsave("41_estimation.png", path = fig_path, height = 12, width = 24)
graphics.off()
...
ggsave("42_leverage.png", path = fig_path, height = 12, width = 24)
graphics.off()
...
ggsave("43_depreciation.png", path = fig_path, height = 12, width = 24)
graphics.off()
...
ggsave("44_capital_revenues.png", path = fig_path, height = 12, width = 24)
graphics.off()
...
ggsave("45_capital_shares.png", path = fig_path, height = 12, width = 24)
graphics.off()
...
ggsave("46_oil_import_shares.png", path = fig_path, height = 12, width = 24)
graphics.off()
...
ggsave("47_petrol_cons_shares.png", path = fig_path, height = 12, width = 24)
graphics.off()
...
ggsave("48_cons_imp_shares.png", path = fig_path, height = 12, width = 24)
graphics.off()
...
ggsave("49_final.png", path = fig_path, height = 12, width = 24)
graphics.off()
